<?php
	...
	$sql="SELECT *,user.id as uid FROM user left join heartbeat on user.id=heartbeat.userId ORDER BY buildId,roomId,bedId,heartbeat.id desc";
	$rs=mysql_query($sql);
